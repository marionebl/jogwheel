...
* Development [v1.4.1](https://www.brcdn.org/jogwheel/v1.4.1/?standalone=jogwheel&uglify=false)
* Production [v1.4.1](https://www.brcdn.org/jogwheel/1.4.1/?standalone=jogwheel&uglify=true)
...
---
jogwheel `v1.4.1` is built by Mario Nebl and [contributors](./documentation/contributors.md) with :heart:
...
[brcdn-image]: https://img.shields.io/badge/cdn-v1.4.1-5ec792.svg?style=flat-square
